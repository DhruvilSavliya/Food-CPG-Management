...
public class RawMaterialInventoryDatabasePersistence  implements IRawMaterialInventoryPersistence{
    ...
    public List<RawMaterialInventory> getDefaulter() {
        ...
        String sql = "select rmi.raw_material_id, rmi.quantity, rmi.quantity_uom, rm.manufacturer_id, rm.raw_material_name, v.vendor_name from raw_material_inventory rmi join raw_materials rm on rmi.raw_material_id = rm.raw_material_id join vendors v on rm.vendor_id = v.vendor_id\n" +
